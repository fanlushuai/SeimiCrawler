...
public class OkHttpDownloader implements SeimiDownloader {
    ...
    public Response process(Request request) throws Exception {
        ...
        if (crawlerModel.isUseCookie()) {
            hcBuilder.cookieJar(crawlerModel.getOkHttpCookiesManager(request.getUseCookieOfAccount()));
    ...
    public void addCookies(String account, String url, List<SeimiCookie> seimiCookies) {
        ...
        for (SeimiCookie seimiCookie : seimiCookies) {
            ...
            try {
                crawlerModel.getOkHttpCookiesManager(account).addCookie(new URI(url), cookieBuilder.build());
